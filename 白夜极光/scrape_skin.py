...
def run(playwright: Playwright) -> None:
  ...
  index_url = 'https://wiki.biligame.com/byjg/%E5%85%89%E7%81%B5%E5%9B%BE%E9%89%B4'
  page.goto(index_url)

  history = open('history.txt', 'a', encoding='utf8')
  index_selector = 'div.divsort div[style*="left:0px;top:0px"] a[title]'
  download_selector = 'div[class="lihui"] img'
  skip_set = skip()
