...
def run(playwright: Playwright) -> None:
  ...
  index_url = 'https://wiki.biligame.com/sssj/%E5%B0%91%E5%A5%B3%E5%9B%BE%E9%89%B4'
  page.goto(index_url)

  history = open('history.txt', 'a', encoding='utf8')
  index_selector = 'div.floatnone a'
  download_selector = 'div.carousel-inner div.item img'
  skip_set = skip()
