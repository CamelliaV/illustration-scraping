...
def run(playwright: Playwright) -> None:
  ...
  index_url = 'https://wiki.biligame.com/bjhl/%E8%AE%B0%E5%BF%86%E7%83%99%E7%97%95%E5%9B%BE%E9%89%B4'
  page.goto(index_url)

  history = open('history.txt', 'a', encoding='utf8')
  index_selector = 'div.memory-bg a'
  download_selector = 'div[data-img] img'
  skip_set = skip()
  ...
  for i in range(len(all_set)):
    ...
    img = page.query_selector_all(download_selector)[-1]
