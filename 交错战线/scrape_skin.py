...
def run(playwright: Playwright) -> None:
  ...
  index_url = 'https://wiki.biligame.com/crosscore/%E8%A7%92%E8%89%B2%E5%9B%BE%E9%89%B4'
  page.goto(index_url)
  
  history = open('history.txt', 'a', encoding='utf8')
  index_selector = 'div.members div.members_pic a'
  download_selector = 'div.crosscore-character-pic div[class="visible-md visible-sm visible-lg"] img[srcset]'
  skip_set = skip()
